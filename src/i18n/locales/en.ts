export default {
  ...
  skills: {
    ...
    binaryPreviewTitle: 'Preview unavailable in the panel',
    binaryPreviewDescription: 'This attachment is better viewed in a new tab or downloaded locally.',
  ...
  profile: {
    title: 'Profile',
    description: 'Shows Hermes role specialization plus the long-term user preferences currently stored.',
    refresh: 'Refresh',
    loadFailed: 'Failed to load profile',
    saveFailed: 'Failed to save profile',
    roleConfigSaveFailed: 'Failed to save role config',
    noProfile: 'No user preferences yet.',
    noRoles: 'No role configuration found.',
    profilePlaceholder: 'Edit raw USER.md content...',
    rolesConfigPlaceholder: 'Edit role config JSON using a roles array structure',
    rolesConfigHelp: 'Role config is stored at ~/.hermes/memories/PROFILE_ROLES.json and will drive the role view after saving.',
    rolesTitle: 'Role Specialization',
    primaryUseCases: 'Best Used For',
    responsibilities: 'Core Responsibilities',
    boundaries: 'Boundaries',
    userPreferences: 'Long-Term User Preferences',
    rawProfile: 'Raw Profile Content',
    rawRolesConfig: 'Raw Role Config',
    editRaw: 'Edit Raw Profile',
    editRolesConfig: 'Edit Role Config',
    roleConfigSourceDefault: 'Default role config',
    roleConfigSourceFile: 'Custom role config',
  },
